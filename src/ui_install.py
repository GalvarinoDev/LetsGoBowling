...
Three screens:
  ...
  InstallScreen    -- progress bar + log. Runs the full pipeline in a
                      background thread:
                        ...
                        5b. Install Xbox Rain Droplets (optional)
                        6. Install Console Visuals packs
                        6b. Install Attramet restoration mods (optional)
                        7. Install Various Fixes + optional content
                        7b. Props Restoration compat patches (auto)
...
class InstallScreen(QWidget):
    ...
    Pipeline order:
      ...
      6b. Install Attramet restoration mods (optional)
      7.  Install Various Fixes + optional content
      7b. Props Restoration compat patches (auto, if props_restoration installed)
    ...
    def _run(self):
        ...
        Mod install order:
          ...
          5b. Xbox Rain Droplets (optional) -- ASI plugin into plugins/
          6.  Console Visuals packs -- merge into update/ via Fusion Overloader
        ...
        self._s.progress.emit(32, "Installing FusionFix...")
        ...
        if self.install_xrd:
            self._s.progress.emit(37, "Installing Xbox Rain Droplets...")
        ...
        if self.cv_packs:
            self._s.progress.emit(42, "Installing Console Visuals...")
        ...
        if self.install_vf:
            self._s.progress.emit(62, "Installing Various Fixes...")
        ...
        if "props_restoration" in (self.attramet_packs or []):
            self._s.progress.emit(65, "Applying Props Restoration compat patches...")
